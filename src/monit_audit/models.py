...
class MonitAuditMilk(models.Model):
    ...
    groups = models.TextField(verbose_name='Разделение по группам', blank=True,  max_length=1000, )
    diet_composition = models.TextField(verbose_name='Состав рациона', blank=True,  max_length=1000, )
    diet_composition_feed = models.TextField(verbose_name='Состав комбикорма', blank=True,  max_length=1000, )
    notes_diet = models.TextField(verbose_name='Замечания по рациону', blank=True,  max_length=4000, )
    notes_animall = models.TextField(verbose_name='Замечания по животным', blank=True,  max_length=4000, )
    withdrawal = models.TextField(verbose_name='Выбытие(количество, причины)', blank=True, max_length=1000, )
    notes = models.TextField(verbose_name='Другие проблемы', blank=True,  max_length=4000, )
    offers = models.TextField(verbose_name='Предложения', blank=True,  max_length=4000, )
    ...
    # number_boxes = models.CharField(verbose_name='Количество боксов для телят',  max_length=100, )
    # number_calf = models.CharField(verbose_name='Количество телят 0-2 мес',  max_length=100, )
    # number_milk = models.CharField(verbose_name='Количество поений молоком в сутки', max_length=100, )
    # diet_calf = models.TextField(verbose_name='Рацион телят', blank=True,  max_length=1000, )
    # offers = models.TextField(verbose_name='Предложения', blank=True,  max_length=4000, )
    # created_at = models.DateTimeField(verbose_name='Дата создания записи', default=timezone.now,)
    # job = models.ForeignKey(Job, on_delete=models.PROTECT, verbose_name='Должность специалиста', )
    # user_name = models.CharField(verbose_name='ФИО', max_length=100, )