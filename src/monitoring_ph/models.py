...
class Monitoring_ph(models.Model):
    ...
    ###
    calving_1 = models.CharField(verbose_name='Дата перевода в "сухостой-2"', max_length=30, null=True, blank=True)
    calving_2 = models.CharField(verbose_name='Дата перевода в "сухостой-2"', max_length=30, null=True, blank=True)
    calving_3 = models.CharField(verbose_name='Дата перевода в "сухостой-2"', max_length=30, null=True, blank=True)
    calving_4 = models.CharField(verbose_name='Дата перевода в "сухостой-2"', max_length=30, null=True, blank=True)
    calving_5 = models.CharField(verbose_name='Дата перевода в "сухостой-2"', max_length=30, null=True, blank=True)
    calving_6 = models.CharField(verbose_name='Дата перевода в "сухостой-2"', max_length=30, null=True, blank=True)
    calving_7 = models.CharField(verbose_name='Дата перевода в "сухостой-2"', max_length=30, null=True, blank=True)
    calving_8 = models.CharField(verbose_name='Дата перевода в "сухостой-2"', max_length=30, null=True, blank=True)
    calving_9 = models.CharField(verbose_name='Дата перевода в "сухостой-2"', max_length=30, null=True, blank=True)
    calving_10 = models.CharField(verbose_name='Дата перевода в "сухостой-2"', max_length=30, null=True, blank=True)
    ###
